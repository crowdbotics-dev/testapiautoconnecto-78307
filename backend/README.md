...
## Project Structure
    ...
    ├── testapiautoconnecto_78307  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_78307`
...
2. Clone this repo and `cd testapiautoconnecto_78307`
